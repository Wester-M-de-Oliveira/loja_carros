...
<body>
<div class="btn-large azul-marinho right">
...
<div class="section no-pad-bot" id="index-banner">
      <div class="container">
        ...
        <img src="../assets/images/MORANDI (1).svg" width="300"/>
          <div class="col s12">
            ...
            ?>
            <h4 class="ligth"><?php echo $marcaselecionada; ?></h4>
